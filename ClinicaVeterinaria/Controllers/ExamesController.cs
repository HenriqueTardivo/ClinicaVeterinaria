...
namespace ClinicaVeterinaria.Controllers
{
    public class ExamesController : Controller
    {
        ...
        public ExamesController(ClinicaVeterinariaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Descricao")] Exame exame)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Descricao")] Exame exame)
        {
            if (id != exame.Id)
            {
                return NotFound();
